                                ...
                                <div class="card custom-card contactus-form overflow-hidden">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center">
                                                <button class="btn btn-secondary-light btn-wave" data-bs-toggle="modal" data-bs-target="#create-folder{{$campaign->id}}">Edit</button>

                                                <div class="modal fade" id="create-folder{{$campaign->id}}" tabindex="-1"
                                                 aria-labelledby="create-folder" data-bs-keyboard="false"
                                                 aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post" action="{{route('update_campaign', $campaign->id)}}">
                                                            ...
                                                            <div class="modal-body px-4">
                                                                ...
                                                                <div class="row gy-2">
                                                                    ...
                                                                    <div class="col-xl-6">
                                                                        <label class="form-label">Currency</label>
                                                                        <select class="form-control blog-tags3" name="currency" multiple>
                                                                            <option value="Choice 1" selected>KES</option>
                                                                            <option value="Choice 2">USD</option>
                                                                        </select>
                                                                    ...
                                                                    <div class="col-xl-6">
                                                                        <label class="form-label">Amount Suggestions</label>
                                                                        <select class="form-control blog-tags4" name="amount_suggestions_usd" value="{{$campaign -> amount_suggestions_usd}}" multiple>
                                                                            <option value="Choice 1" selected>$100</option>
                                                                            <option value="Choice 2">$50</option>
                                                                        </select>
                                                                    </div>
